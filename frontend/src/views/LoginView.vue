...
<template>
  <div class="flex min-h-full">
    <!-- Background Image -->
    <img
      class="absolute inset-0 size-full object-cover xl:-translate-x-90"
    ...
    <div
      class="flex flex-1 flex-col justify-center xl:rounded-r-lg relative overflow-hidden xl:p-0.5"
    >
      <!-- Overlay -->
      ...
      <div class="relative z-10 text-black">
        <div class="sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div
            class="space-y-10 bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12"
          >
            ...
            <form @submit.prevent="handleLogin" class="space-y-6">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm/6">
                  <a
                    href="#"
                    class="font-semibold text-accentcolor hover:text-indigo-500"
                    >Forgot password?</a
                  >
                </div>
              </div>
